...
\begin{center}
	\begin{figure} [h]
		\centering
		\subfloat[Fitting for $l_0$ values]{\includegraphics[width = 2.8in]{./figures/ex1_5_5.png}} 
		\hspace{8mm}
		\subfloat[Fitting for $Re$ values]{\includegraphics[width = 3.0in]{./figures/ex1_5_6.png}}
...
\begin{center}
	\begin{figure} [h]
		\centering
		\stackunder[5pt]{\includegraphics[width = 2.0in]{./figures/quad1.png}}{} 
		\hspace{8mm}
		\stackunder[5pt]{\includegraphics[width = 2.0in]{./figures/quad2.png}}{}
		\\
		\centering
		\stackunder[5pt]{\includegraphics[width = 2.0in]{./figures/quad3.png}}{}
		\hspace{8mm}
		\stackunder[5pt]{\includegraphics[width = 2.0in]{./figures/quad4.png}}{}
